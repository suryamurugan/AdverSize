...
public class AdaptorMedia extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdaptorMedia(Context context, List<MediaObject> data){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // Toast.makeText(context,"yo"+myHolder.getItemId(), Toast.LENGTH_SHORT).show();
                 Toast.makeText(context, ""+media.getMediaName(), Toast.LENGTH_SHORT).show();
...
*/
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(View itemView) {
            ...
            mediaName= itemView.findViewById(R.id.title);
